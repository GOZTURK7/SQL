...
/* -----------------------------------------------------------------------------
  ORNEK3: Honda,Ford ve Tofas'ta calisan personelin ismini listeleyin varsa listeleyin
------------------------------------------------------------------------------*/
...
/* -----------------------------------------------------------------------------
  ORNEK5: Ismi Mehmet Ozturk olanlarin Şehirlerini + olarak Istanbul'da calismayanlarin isimlerini ve 
...
-- serketlerden grupla , sirketlerin çalişan isimlerini say

select sirket, count(isim) toplam_kisi from personel
group by sirket;
