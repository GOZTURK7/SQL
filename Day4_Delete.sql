-- ============================== DELETE ===================================  
    ...
    savepoint abc; -- insert edilen tablo verilerini ekstra bir yerde yedekliyor.
	
    delete from ogrenciler; -- tablo içeriğini bu şekilde komple sildikten sonra aşağdaki komutla geri getirebiliyoruz.
    
	rollback to abc; -- bu komutla geri getirebiliyoruz çünkü insert intolardan hemen sonra avepoint abc; yapmştk,
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/        
   ...
   -- 2. YOL
   delete from ogrenciler
   where isim in ('Nesibe Yilmez', 'Mustafa Bak');
